...
Base.extend = function(t, i) {
    ...
    extend: function(t, i) {
        if (arguments.length > 1) {
            ...
            for (var o = {
                    toSource: null
                }, a = ["constructor", "toString", "valueOf"], c = Base._prototyping ? 0 : 1; r = a[c++];) t[r] != o[r] && s.call(this, r, t[r]);
...
function(t) {
    ...
    FlipClock.Face = FlipClock.Base.extend({
        ...
        createDivider: function(i, e, n) {
            ...
            n && (s = "");
            var o = ['<span class="' + this.factory.classes.divider + " " + (e || "").toLowerCase() + '">', '<span class="' + this.factory.classes.label + '"></span>', s, "</span>"],
                a = t(o.join(""));
